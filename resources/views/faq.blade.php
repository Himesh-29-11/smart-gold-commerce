        ...
        <div>
            ...
            <div style="margin-top: 25px;">
                <details class="faq-accordion" open>
                    <summary>Why are Ahmedabad gold rates different from global spot prices?</summary>
                    <p>In India, city-specific gold rates vary from international XAU/USD spot rates due to MCX (Multi Commodity Exchange of India) futures pricing, import duties, transportation charges, and local jewellers association markups. Our platform implements an Ahmedabad Sarafa Bazaar Bullion Engine that applies a configurable local premium (+0.45% default) over base INR spot rates.</p>
                </details>

                <details class="faq-accordion">
                    <summary>How is BIS Hallmark &amp; purity certified on my purchase?</summary>
                    <p>Every product card explicitly identifies its carat purity (22K or 24K) and Bureau of Indian Standards (BIS) hallmark number prior to purchase. Furthermore, your itemized invoice lists the exact gold weight, making charge, and 3% GST breakdown.</p>
                </details>

                <details class="faq-accordion">
                    <summary>Does N &amp; H Trust issue loans or finance gold directly?</summary>
                    <p>No. N &amp; H Trust is a luxury commerce platform, not an NBFC or lender. We provide an independent EMI estimator and route your consented assistance request to regulated lending partners. We never collect or store sensitive KYC documents locally.</p>
                </details>

                <details class="faq-accordion">
                    <summary>How does own-fleet GPS delivery tracking protect my order?</summary>
                    <p>High-value bullion shipments are assigned to verified own-fleet drivers. Once delivery begins, you can track approximate courier coordinates on an interactive Leaflet OpenStreetMap. For security, coordinates are rounded to a 100-meter privacy radius.</p>
                </details>

                <details class="faq-accordion">
                    <summary>What is my 4-Digit Customer ID and Order Code?</summary>
                    <p>Every registered user is assigned an ascending 4-digit Customer ID (starting from #1001), and every order receives an ascending 4-digit Order Code (starting from #5001, formatted as SGC-5001). This allows our operations team to locate your records instantly.</p>
                </details>
            </div>
        </div>

        <div class="form-card" style="border-radius: 14px; width: 100%; box-sizing: border-box;">
